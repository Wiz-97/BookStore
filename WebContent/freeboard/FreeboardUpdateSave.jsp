...
<%
	...
	FreeboardVo vo 
	= new FreeboardVo(f_idx,mno,null,f_subject,f_content,f_password,0,null,0,0);

	freedao.update(vo);
	response.sendRedirect("FreeboardDetailAction.jsp?idx="+f_idx +"&page="+pageNo);   //글목록 화면으로 url 재요청
%>